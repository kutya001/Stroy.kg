...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Ошибка при создании товара/услуги');
      setLoading(false);
    }
  };
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 pt-6 pb-24 space-y-6">
      <div className="flex items-center gap-4 border-b border-slate-200 pb-4">
        ...
        <div>
          <h1 className="text-2xl font-heading font-bold text-secondary">Добавить позицию</h1>
          <p className="text-slate-500 text-sm">Новый товар или услуга в каталог</p>
        </div>
      </div>
